...
public class Result_qingActivity extends Activity{
	...
	{
		Toast.makeText(Result_qingActivity.this, message, Toast.LENGTH_SHORT).show();
	}
	public void dialogshow()
	{
		if (mDialog == null) {

			mDialog = new ProgressDialog(Result_qingActivity.this);
	...
	{
		Intent _Intent = new Intent(Result_qingActivity.this,Result_qingActivity.class);
		startActivity(_Intent);
	}
	public void startResult_yuActivity()
	{
		Intent _Intent = new Intent(Result_qingActivity.this,Result_yuActivity.class);
		startActivity(_Intent);
	}
	public void startResult_leiyuActivity()
	{
		Intent _Intent = new Intent(Result_qingActivity.this,Result_leiyuActivity.class);
		startActivity(_Intent);
	}
	public void startResult_yinActivity()
	{
		Intent _Intent = new Intent(Result_qingActivity.this,Result_yinActivity.class);
		startActivity(_Intent);
	}
	public void init()
	{
			...
			if (_Intent != null)
			{
				...
				btn_find_weather.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						Intent _Intent = new Intent(Result_qingActivity.this,FindWeatherActivity.class);
						startActivity(_Intent);										
					}
				});
	...
	private static class IHandler extends Handler {
		...
		public IHandler(Result_qingActivity activity) {
		...
		public void handleMessage(Message msg) {
			...
			case Constant_weather.FLAG_WEATHER_QING:
				((Result_qingActivity) mActivtiy.get()).startResult_qingActivity();
				break;
			case Constant_weather.FLAG_WEATHER_YU:
				((Result_qingActivity) mActivtiy.get()).startResult_yuActivity();
	
				break;
			case Constant_weather.FLAG_WEATHER_YIN:
				Log.i("wzs", "case接受成功");
				((Result_qingActivity) mActivtiy.get()).startResult_yinActivity();

				break;
			case Constant_weather.FLAG_WEATHER_LEIYU:
				((Result_qingActivity) mActivtiy.get()).startResult_leiyuActivity();

				break;
			case 0:
				String ERRORMSG = msg.getData().getSerializable("ERROR")
						.toString();
				((Result_qingActivity) mActivtiy.get()).toastShow(ERRORMSG);
				break;
			}
		}
