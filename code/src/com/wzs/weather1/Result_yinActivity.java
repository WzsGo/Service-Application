...
public class Result_yinActivity extends Activity{
	...
	{
		Toast.makeText(Result_yinActivity.this, message, Toast.LENGTH_SHORT).show();
	}
	public void dialogshow()
	{
		if (mDialog == null) {

			mDialog = new ProgressDialog(Result_yinActivity.this);
	...
	{
		Intent _Intent = new Intent(Result_yinActivity.this,Result_qingActivity.class);
		startActivity(_Intent);
	}
	public void startResult_yuActivity()
	{
		Intent _Intent = new Intent(Result_yinActivity.this,Result_yuActivity.class);
		startActivity(_Intent);
	}
	public void startResult_leiyuActivity()
	{
		Intent _Intent = new Intent(Result_yinActivity.this,Result_leiyuActivity.class);
		startActivity(_Intent);
	}
	public void startResult_yinActivity()
	{
		Intent _Intent = new Intent(Result_yinActivity.this,Result_yinActivity.class);
		startActivity(_Intent);
	}
	public void init()
	{
			...
			if (_Intent != null)
			{
				...
				btn_find_weather.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View arg0) {
						Intent _Intent = new Intent(Result_yinActivity.this,FindWeatherActivity.class);
						startActivity(_Intent);										
					}
				});
	...
	private static class IHandler extends Handler {
		...
		public IHandler(Result_yinActivity activity) {
		...
		public void handleMessage(Message msg) {
			...
			case Constant_weather.FLAG_WEATHER_QING:
				((Result_yinActivity) mActivtiy.get()).startResult_qingActivity();
				break;
			case Constant_weather.FLAG_WEATHER_YU:
				((Result_yinActivity) mActivtiy.get()).startResult_yuActivity();
	
				break;
			case Constant_weather.FLAG_WEATHER_YIN:
				Log.i("wzs", "case接受成功");
				((Result_yinActivity) mActivtiy.get()).startResult_yinActivity();

				break;
			case Constant_weather.FLAG_WEATHER_LEIYU:
				((Result_yinActivity) mActivtiy.get()).startResult_leiyuActivity();

				break;
			case 0:
				String ERRORMSG = msg.getData().getSerializable("ERROR")
						.toString();
				((Result_yinActivity) mActivtiy.get()).toastShow(ERRORMSG);
				break;
			}
		}
